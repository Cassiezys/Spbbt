...
public class AliyunProvider {
    ...
    @Value("${aliyun.oss.access-key}")//账号
     ...
     * @param imageType
     */
    public static String upload(String fileName, InputStream fileStream, String imageType) {
        // 图片类型（必选）取值范围：default（默认)，cover（封面），watermark(水印)
        imageType = "cover";
        UploadImageRequest request = new UploadImageRequest(AliyunProvider.accessKeyId, AliyunProvider.accessKeySecret, imageType);
     ...
     * fileStream 文件流
     * mineType 文件类型*/
   /* public String upload(String fileName,InputStream fileStream,String mineType){
        return "";
    }*/
